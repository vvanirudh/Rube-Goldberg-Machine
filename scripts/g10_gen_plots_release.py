...
plt.savefig("plots_non2/g10_plot01.png")
####################################################################################################
plt.figure(2)
plt.plot(k,xestep,'bx',label="Average step time")
...
plt.legend()
plt.savefig("plots_non2/g10_plot02.png")	
#################################################################################################
plt.figure(3)
...
plt.legend()
plt.savefig("plots_non2/g10_plot03_1.png")
####################################################################################################
plt.figure(4)
plt.plot(k,rxestep,'bx',label="Average step time")
...
plt.legend()
plt.savefig("plots_non2/g10_plot03_2.png")
#####################################################################################################
plt.figure(5)
...
plt.xlabel("iteration value")
plt.ylabel("time")
plt.savefig("plots_non2/g10_plot04.png")
########################################################################################################
plt.figure(6)
...
plt.savefig("plots_non2/g10_plot05.png")
